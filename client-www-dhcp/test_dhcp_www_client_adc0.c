 ...
 * the webserver at webserver_vhost at startup and then every 60min
 ...
 * 70.80.220.56 :: 2012-01-28 18:08 GMT :: action=auto :: adc0=280 :: ethbrd_ip=10.0.0.30 :: pw=sec ::
 *
 * There are two LEDs you can connect to the circuit to be able to
 * see what is going on.
 *
 * LED1 between PB1 and Vcc: this LED will be off during transactions and go
