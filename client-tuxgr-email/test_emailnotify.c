        ...
        while(1){
                ...
                if(dat_p==0){
                        ...
                        if (start_web_client==1){
                                ...
                                client_browse_url(PSTR("/cgi-bin/mm?a=gus123&s=test+emailnotify&d="),urlvarstr,PSTR(WEBSERVER_VHOST),&browserresult_callback,otherside_www_ip,gwmac); // would be the same as http://tuxgraphics.org/cgi-bin/mm?a=gus123&s=test+emailnotify&d=Board+1:+PD6+closed
                        }
